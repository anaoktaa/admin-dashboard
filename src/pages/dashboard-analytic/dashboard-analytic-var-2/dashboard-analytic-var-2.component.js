...
import { ScheduleOutlined, DownOutlined, AppstoreOutlined, QrcodeOutlined, GlobalOutlined,
    ...
    return (
        <div>
            ...
            <div className='flex-row justify-content-center mb-30'>
                <CustomButton shadow icon={<GlobalOutlined />} size='large' variant='solid' color='dark' pill={true}>
                    ...
                    <CustomCardBody>
                        <div className='dashboard-analytic-timeline-container'>
                            <CustomTimeline size='regular'>
                                ...
                                <CustomTimelineItem>
                                    <Text className='color6d fs-14'>Another meeting today, <span className='success'>at 11.00 AM</span></Text>
                                </CustomTimelineItem>
                                <CustomTimelineItem>
                                    <Text className='color6d fs-14'>Build the production release</Text>
                                </CustomTimelineItem>
                                <CustomTimelineItem>
                                    <Text className='fw-bold fs-14 success'>Something not important</Text>
                                </CustomTimelineItem>
                                <CustomTimelineItem>
                                    <Text className='color6d fs-14'>All hands meeting</Text>
                                </CustomTimelineItem>
